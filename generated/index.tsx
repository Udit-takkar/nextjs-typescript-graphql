...
export type TestingQuery = { __typename?: 'Query', characters?: Maybe<{ __typename?: 'Characters', results?: Maybe<Array<Maybe<{ __typename?: 'Character', id?: Maybe<string>, image?: Maybe<string>, name?: Maybe<string>, gender?: Maybe<string>, species?: Maybe<string> }>>> }> };
...
export const TestingDocument = gql`
    query testing($page: Int, $filter: FilterCharacter) {
  characters(page: $page, filter: $filter) {
    results {
      id
      image
